...
class GitIgnore < Formula
  ...
  homepage "https://github.com/gitignore-cli/git-ignore"
  url "https://github.com/gitignore-cli/git-ignore/releases/download/v0.2.1/git-ignore-x86_64-apple-darwin.tar.gz"
